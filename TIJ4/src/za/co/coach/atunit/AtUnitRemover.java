...
// Displays @Unit za.co.coach.learning.tij.annotations in compiled class files. If
// first argument is "-r", @Unit za.co.coach.learning.tij.annotations are removed.
// {Args: ..}
...
import za.co.coach.util.BinaryFile;
import za.co.coach.util.ProcessFiles;
		...
		try {
			...
			for (CtMethod method : ctClass.getDeclaredMethods()) {
				...
				for (Annotation ann : attr.getAnnotations()) {
					if (ann.getTypeName().startsWith("za.co.coach.atunit")) {
