...
//: za.co.coach.learning.tij.generics/WatercolorSets.java
import static za.co.coach.learning.tij.generics.watercolors.Watercolors.BRILLIANT_RED;
import static za.co.coach.learning.tij.generics.watercolors.Watercolors.BURNT_UMBER;
import static za.co.coach.learning.tij.generics.watercolors.Watercolors.CERULEAN_BLUE_HUE;
import static za.co.coach.learning.tij.generics.watercolors.Watercolors.VIRIDIAN_HUE;
import static za.co.coach.util.Print.print;
import static za.co.coach.util.Sets.complement;
import static za.co.coach.util.Sets.difference;
import static za.co.coach.util.Sets.intersection;
import static za.co.coach.util.Sets.union;

import java.util.EnumSet;
import java.util.Set;

import za.co.coach.learning.tij.generics.watercolors.Watercolors;
