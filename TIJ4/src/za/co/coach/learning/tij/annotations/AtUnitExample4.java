//: za.co.coach.learning.tij.annotations/AtUnitExample4.java
...
public class AtUnitExample4 {
	...
	public static void main(String[] args) throws Exception {
		...
		OSExecute.command("java za.co.coach.atunit.AtUnit AtUnitExample4");
	}
} /* Output:
starting
za.co.coach.learning.tij.annotations.AtUnitExample4
. scramble1 'All'
lAl
