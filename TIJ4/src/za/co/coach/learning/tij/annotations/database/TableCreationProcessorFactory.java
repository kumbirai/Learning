//: za.co.coach.learning.tij.annotations/database/TableCreationProcessorFactory.java
// The database example using Visitor.
// {Exec: apt -factory
// za.co.coach.learning.tij.annotations.database.TableCreationProcessorFactory
...
public class TableCreationProcessorFactory implements AnnotationProcessorFactory {
	...
	public Collection<String> supportedAnnotationTypes() {
		return Arrays.asList("za.co.coach.learning.tij.annotations.database.DBTable", "za.co.coach.learning.tij.annotations.database.Constraints",
				"za.co.coach.learning.tij.annotations.database.SQLString", "za.co.coach.learning.tij.annotations.database.SQLInteger");
	}
