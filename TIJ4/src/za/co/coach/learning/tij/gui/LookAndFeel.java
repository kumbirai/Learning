...
//: za.co.coach.learning.tij.gui/LookAndFeel.java
...
public class LookAndFeel extends JFrame {
	...
	private Component[] samples = { new JButton("JButton"), new JTextField("JTextField"), new JLabel("JLabel"), new JCheckBox("JCheckBox"),
			new JRadioButton("Radio"), new JComboBox(choices), new JList(choices), };
