...
//: za.co.coach.learning.tij.typeinfo/Staff.java
...
public class Staff extends ArrayList<Position> {
	...
	public static void main(String[] args) {
		Staff staff = new Staff("President", "CTO", "Marketing Manager", "Product Manager", "Project Lead", "Software Engineer", "Software Engineer",
