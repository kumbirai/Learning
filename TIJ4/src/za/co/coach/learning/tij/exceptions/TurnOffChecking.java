...
//: za.co.coach.learning.tij.exceptions/TurnOffChecking.java
// "Turning off" Checked za.co.coach.learning.tij.exceptions.
...
public class TurnOffChecking {
	public static void main(String[] args) {
		...
		// Or you can choose to catch za.co.coach.learning.tij.exceptions:
		for (int i = 0; i < 4; i++)
			try {
				if (i < 3)
